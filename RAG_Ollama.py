...
login("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")
model_id = "meta-llama/Meta-Llama-Guard-2-8B"
device = "cuda"
dtype = torch.bfloat16
access_token = "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"

quantization_config = BitsAndBytesConfig(load_in_8bit = True, llm_int8_enable_fp32_cpu_offload = True)

llm = OllamaFunctions(model="llama3", format="json", temperature=20)
...
response = rag_chain.invoke({"input": "What is the task decomposition?"})
